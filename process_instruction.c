		...
		stack_t **stack, unsigned int line_num, FILE *bytecode_file)
{
	instruction_t instructions[] = {
		{"push", push}, {"pall", pall},
		{"pint", pint}, {"pop", pop},
		{"add", sum_top_elements}, {"swap", swap},
		{"nop", do_nothing}, {"sub", sub_top_elements},
		{"div", div_top_elements}, {"mul", multiply_top_two},
		{"mod", compute_remainder}, {"pchar", print_char},
		{"pstr", print_string}, {"rotl", rotl},
		{"rotr", rotr}, {"queue", enable_queue_mode},
